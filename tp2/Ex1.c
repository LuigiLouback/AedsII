...
int num_alternate_names = 0;
 ...
 //ESTOU IMPRIMINDO FALSE POR CAUSA DO VERDE 
  printf("## %s ## %s ## %s ## %s ## false ## false ## %s ## false ## %s ## %d ## %s ## %s ## %s ## false]\n",personagem->house,personagem->ancestry,personagem->species,personagem->patronus,
    personagem->actorName,personagem->dateOfBirth,personagem->yearOfBirth,personagem->eyeColour,personagem->gender,personagem->hairColour);
