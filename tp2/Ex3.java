...
class Personagens {
  ...
  public class Ex3{
    public static void main(String[] args) {
        ...
        //ler id da entrada
        int z=0;
        String nomesInseridos[]=new String [1000];
        ...
        while(!linhalida.equals("FIM")){
            for(int u=0;u<personagens.size();u++){
               ...
               if(linhalida.equals(personagens.get(u).getId())){
                nomesInseridos[z]=personagens.get(u).getName();
                z++;
        ...
        while(!linhalida.equals("FIM")){
            boolean resp=false;
            for(int q=0;q<z;q++){
                if(linhalida.equals(nomesInseridos[q])){
                   resp=true;
                   q=z; 
                }
                numcomp++;
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("matricula_sequencial.txt"))) {
            ...
            writer.write("814143\t" + duration + "\t" +numcomp);
        } catch (IOException e) {
