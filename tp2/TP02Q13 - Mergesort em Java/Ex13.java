...
//import java.time.format.DateTimeFormatter;
 class Personagens {
  ...
  public class Ex13{
    ...
    static void mergesort(int esq, int dir, Personagens[] array) {
        if (esq < dir) {
            int meio = (esq + dir) / 2;
    ...
    static void intercalar(int esq, int meio, int dir, Personagens[] array) {
        int n1 = meio - esq + 1;
        int n2 = dir - meio;
    ...
    public static void main(String[] args) {
        ...
        int numcomp = 0;
        int nummovi = 0;
        mergesort(0, z - 1, nomesInseridos);
